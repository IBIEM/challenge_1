...
You should have received an email invitation to access this assigment in Github Classroom.  If you haven't received it by the end of class on August 31st, please contact the TAs.
...
5. Choose Git
6. Paste the repo URL into the *Repository URL*.  It should be something like `git@github.com:IBIEM/challenge-1-[USERNAME].git`, but with your Github username substituted for the `[USERNAME]` part.
...
4. Optional: Push changes to Github by clicking the *Commit* button. You don't need to do this every commit . . . but then again, why not? Who doesn't need more off-site backup?
